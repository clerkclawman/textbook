...
# Replace tony-jay-loader.js with the new version
shutil.copy('tony-jay-loader-new.js', 'tony-jay-loader.js')
print('✅ Replaced tony-jay-loader.js with new version')

# Now do the same for quiz-loader.js
# First, read the new quiz loader content
quiz_content = """/**
 * Quiz Loader
...
with open('quiz-loader-new.js', 'w') as f:
 f.write(quiz_content)

shutil.copy('quiz-loader-new.js', 'quiz-loader.js')
print('✅ Replaced quiz-loader.js with new version')

print('\\n✅ Both loaders replaced!')
print('Now run: git add tony-jay-loader.js quiz-loader.js && git commit -m "Fix: Rewrite loaders to wait for lessonsData" && git push')
